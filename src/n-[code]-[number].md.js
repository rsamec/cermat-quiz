...
import { baseDomainPublic, parseCode, normalizeImageUrlsToAbsoluteUrls, text, formatShortCode } from './utils/quiz-string-utils.js';
...
title: ${formatShortCode(code)} - ${number}
sidebar: false
footer: false
pager: false
toc: false
