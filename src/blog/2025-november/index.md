...
- pro celý test - hlavní menu Testy -> Matika ![alt text](image.png)
- za jednotlivé úlohy - hlavní menu Matematika -> Slovní úlohy a dále klikněte na odkaz konkrétní slovní úlohy  ![alt text](image-4.png)
...
- Postupy řešení úloh v matematice jsou k dispozic u jednotlivých testů ![alt text](image-5.png)