import { comp, compRatio, ctorOption, nthPart, rate, ratios, combine } from "../../components/math";
  ...
  return {
    ...
    deductionTree: deduce(
      deduce(
        ...
        combine(kyticeAgent, [ruzeAgent, chryzatemaAgent, staticAgent], entity, entity)
      ),
      ctorOption("D", 1_300)
    )
  }
